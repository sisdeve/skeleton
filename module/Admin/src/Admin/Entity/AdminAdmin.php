 ...
 * AdminAdmin
 *
 * @ORM\Table(name="admin_admin", uniqueConstraints={@ORM\UniqueConstraint(name="email_UNIQUE", columns={"email"})})
 * @ORM\Entity
 * @ORM\HasLifecycleCallbacks
 * @ORM\Entity(repositoryClass="Admin\Entity\AdminAdminRepository")
 */
class AdminAdmin extends AbstractEntity
{
    /**
     * @var integer
     *
    ...
    /**
     * Método responsavel por encryptar a senha
     * @param $senha
     * @return string
     */
